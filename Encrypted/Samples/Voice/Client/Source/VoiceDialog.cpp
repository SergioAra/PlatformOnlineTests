...
void FVoiceDialog::SetPosition(Vector2 Pos)
{
	...
	if (JoinRoomButton) JoinRoomButton->SetPosition(Pos + Vector2(400.f, 40.f));
...
void FVoiceDialog::SetSize(Vector2 NewSize)
{
	...
	if (RoomNameText) RoomNameText->SetSize(Vector2(300.0f, 25.0f));
	if (JoinRoomButton) JoinRoomButton->SetSize(Vector2(100.0f, 20.f));
	if (LeaveRoomButton) LeaveRoomButton->SetSize(Vector2(100.0f, 20.f));
